            ...
            <div class="bg-white rounded-lg shadow-md">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <!-- ✨ NEW: Room Types Management -->
                        <a href="{{ route('admin.room-types.index') }}" 
                           class="flex items-center p-4 bg-indigo-50 hover:bg-indigo-100 rounded-lg transition-colors duration-200 group">
                            <div class="flex-shrink-0">
                            ...
                            <div class="ml-4">
                                <h3 class="text-sm font-semibold text-gray-900">🏨 Manage Room Types</h3>
                                <p class="text-sm text-gray-600">Create and manage room types, pricing, and amenities</p>
                            </div>
                            <div class="ml-auto">
                                <svg class="w-5 h-5 text-gray-400 group-hover:text-gray-600" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
